...
import net.qixiaowei.system.manage.api.factory.RemoteLogFallbackFactory;
 ...
 * 
 */
@FeignClient(contextId = "remoteLogService", value = ServiceNameConstants.SYSTEM_MANAGE_SERVICE, fallbackFactory = RemoteLogFallbackFactory.class)
