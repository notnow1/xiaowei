 ...
 * 行业服务
 */
@FeignClient(contextId = "remoteIndustryService", value = ServiceNameConstants.SYSTEM_MANAGE_SERVICE, fallbackFactory = RemoteEmployeeFallbackFactory.class)
public interface RemoteIndustryService {
    String API_PREFIX_EMPLOYEE = "/industry";
