...
INSERT INTO message_content_config (message_type, business_type, business_subtype, receive_role, message_template, receive_user, delete_flag, create_by, create_time, update_by, update_time) VALUES(3, 2, 200, 0, '您好，您的增略管理平台登录密码重置成功，新密码为{password}，为确保账号安全，登录后可在【用户设置】中修改密码。', NULL, 0, 1, sysdate(), 1, sysdate());
