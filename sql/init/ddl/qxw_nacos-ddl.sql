DROP DATABASE IF EXISTS `qxw_nacos`;
CREATE DATABASE `qxw_nacos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `qxw_nacos`;
SET NAMES utf8mb4;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网关路由表';
