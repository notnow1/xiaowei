...
public interface StrategyMetricsPlanMapper {
     ...
     * 根据详情ID集合查询计划表
     *
     * @param strategyMetricsDetailIds 详情ID集合
     * @return List
     */
    List<StrategyMetricsPlanDTO> selectStrategyMetricsPlanByStrategyMetricsDetailIds(@Param("strategyMetricsDetailIds") List<Long> strategyMetricsDetailIds);
}
