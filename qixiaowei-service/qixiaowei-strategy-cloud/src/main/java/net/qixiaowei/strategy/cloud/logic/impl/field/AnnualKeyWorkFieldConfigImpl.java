...
public class AnnualKeyWorkFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(AnnualKeyWorkField.PLAN_RANK.getCode(), FieldConfig.builder().businessType(BusinessType.ANNUAL_KEY_WORK.getCode()).fieldName(AnnualKeyWorkField.PLAN_RANK.getCode()).fieldLabel(AnnualKeyWorkField.PLAN_RANK.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
