...
public interface GapAnalysisPerformanceMapper {
     ...
     * @return List
     */
    List<GapAnalysisPerformanceDTO> selectGapAnalysisPerformanceByGapAnalysisId(@Param("gapAnalysisId") Long gapAnalysisId);
     ...
     * @return 结果
     */
    List<GapAnalysisPerformanceDTO> selectGapAnalysisPerformanceByGapAnalysisIds(@Param("gapAnalysisIds") List<Long> gapAnalysisIds);
}
