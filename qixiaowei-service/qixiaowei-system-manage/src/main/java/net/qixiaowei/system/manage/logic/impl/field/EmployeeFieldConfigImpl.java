...
public class EmployeeFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_EMPLOYEE.put(EmployeeField.TOP_LEVEL_DEPARTMENT_ID.getCode(), FieldConfig.builder().businessType(BusinessType.EMPLOYEE.getCode()).fieldName(EmployeeField.TOP_LEVEL_DEPARTMENT_ID.getCode()).fieldLabel(EmployeeField.TOP_LEVEL_DEPARTMENT_ID.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        ...
        INIT_EMPLOYEE.put(EmployeeField.DEPARTURE_DATE.getCode(), FieldConfig.builder().businessType(BusinessType.EMPLOYEE.getCode()).fieldName(EmployeeField.DEPARTURE_DATE.getCode()).fieldLabel(EmployeeField.DEPARTURE_DATE.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
