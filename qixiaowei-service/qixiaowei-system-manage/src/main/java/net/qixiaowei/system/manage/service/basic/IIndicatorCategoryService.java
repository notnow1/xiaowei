...
public interface IIndicatorCategoryService{
    ...
    * @return 结果
    */
    int logicDeleteIndicatorCategoryByIndicatorCategoryIds(List<IndicatorCategoryDTO> IndicatorCategoryDtos);
    ...
    * @return 结果
    */
    int logicDeleteIndicatorCategoryByIndicatorCategoryId(IndicatorCategoryDTO indicatorCategoryDTO);
    /**
    * 逻辑批量删除指标分类表
    *
    * @param IndicatorCategoryDtos 需要删除的指标分类表集合
