...
public class NationController extends BaseController
{
    ...
    * 查询民族表列表
    */
    //@RequiresPermissions("system:manage:nation:list")
    @GetMapping("/list")
    ...
    */
    ...
    @Log(title = "新增民族表", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    ...
    */
    ...
    @Log(title = "修改民族表", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    ...
    */
    ...
    @Log(title = "删除民族表", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    ...
    * 批量修改民族表
    */
    //@RequiresPermissions("system:manage:nation:edits")
    @Log(title = "批量修改民族表", businessType = BusinessType.UPDATE)
    @PostMapping("/edits")
    public AjaxResult editSaves(@RequestBody List<NationDTO> nationDtos)
    {
    return toAjax(nationService.updateNations(nationDtos));
    }

    /**
    * 批量新增民族表
    */
    //@RequiresPermissions("system:manage:nation:insertNations")
    @Log(title = "批量新增民族表", businessType = BusinessType.INSERT)
    @PostMapping("/insertNations")
    public AjaxResult insertNations(@RequestBody List<NationDTO> nationDtos)
    {
    return toAjax(nationService.insertNations(nationDtos));
    }
    ...
    */
    ...
    @Log(title = "批量删除民族表", businessType = BusinessType.DELETE)
    @PostMapping("/removes")
