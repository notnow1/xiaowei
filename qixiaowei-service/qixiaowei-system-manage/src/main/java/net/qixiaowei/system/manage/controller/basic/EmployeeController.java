...
public class EmployeeController extends BaseController
{
    ...
    */
    ...
    @PostMapping("/add")
    public AjaxResult addSave(@RequestBody EmployeeDTO employeeDTO) {
    ...
    */
    ...
    @PostMapping("/edit")
    public AjaxResult editSave(@RequestBody EmployeeDTO employeeDTO)
    {
    ...
    */
    ...
    @PostMapping("/remove")
    public AjaxResult remove(@RequestBody EmployeeDTO employeeDTO)
    {
    ...
    */
    ...
    @PostMapping("/edits")
    public AjaxResult editSaves(@RequestBody List<EmployeeDTO> employeeDtos)
    {
