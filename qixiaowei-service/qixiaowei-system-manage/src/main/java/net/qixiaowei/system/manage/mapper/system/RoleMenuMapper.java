...
public interface RoleMenuMapper {
     ...
     * @return 角色菜单ID集合
     */
    Set<Long> selectMenuIdsByRoleIds(@Param("roleIds") List<Long> roleIds);
     ...
     * @return 结果
     */
    int cancelRoleMenu(@Param("menuIds") Set<Long> menuIds, @Param("updateBy") Long updateBy, @Param("updateTime") Date updateTime);
