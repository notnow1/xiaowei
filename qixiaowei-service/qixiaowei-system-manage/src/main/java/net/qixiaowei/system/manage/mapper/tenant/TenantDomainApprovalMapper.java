...
public interface TenantDomainApprovalMapper{
    ...
    */
     ...
     * @return 待审核
     */
    TenantDomainApprovalDTO getTenantDomainApprovalByWaiting(@Param("tenantId")Long tenantId);
     ...
     * @return 待审核数量
     */
    Integer countTenantDomainApprovalByWaiting(@Param("tenantId")Long tenantId);
