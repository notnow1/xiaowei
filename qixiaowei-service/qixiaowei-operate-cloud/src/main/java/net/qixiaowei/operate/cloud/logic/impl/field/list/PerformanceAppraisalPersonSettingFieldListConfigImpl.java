...
public class PerformanceAppraisalPersonSettingFieldListConfigImpl implements IFieldListConfigStrategy {
    ...
    static {
        INIT_MAP.put(PerformanceAppraisalPersonSettingField.APPRAISAL_NAME.getCode(), FieldListConfig.builder().fieldWidth(140).sort(1).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        INIT_MAP.put(PerformanceAppraisalPersonSettingField.APPRAISAL_YEAR.getCode(), FieldListConfig.builder().fieldWidth(120).sort(2).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        ...
        INIT_MAP.put(PerformanceAppraisalPersonSettingField.POST_NAME.getCode(), FieldListConfig.builder().fieldWidth(140).sort(7).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
