...
public class PerformanceAppraisalFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(PerformanceAppraisalField.EVALUATION_TYPE.getCode(), FieldConfig.builder().businessType(BusinessType.PERFORMANCE_APPRAISAL.getCode()).fieldName(PerformanceAppraisalField.EVALUATION_TYPE.getCode()).fieldLabel(PerformanceAppraisalField.EVALUATION_TYPE.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
