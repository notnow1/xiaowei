...
public class SalaryPayFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        INIT_MAP.put(SalaryPayField.PAY_YEAR.getCode(), FieldConfig.builder().businessType(BusinessType.SALARY_PAY.getCode()).fieldName(SalaryPayField.PAY_YEAR.getCode()).fieldLabel(SalaryPayField.PAY_YEAR.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        INIT_MAP.put(SalaryPayField.PAY_MONTH.getCode(), FieldConfig.builder().businessType(BusinessType.SALARY_PAY.getCode()).fieldName(SalaryPayField.PAY_MONTH.getCode()).fieldLabel(SalaryPayField.PAY_MONTH.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        ...
        INIT_MAP.put(SalaryPayField.ALLOWANCE_AMOUNT.getCode(), FieldConfig.builder().businessType(BusinessType.SALARY_PAY.getCode()).fieldName(SalaryPayField.ALLOWANCE_AMOUNT.getCode()).fieldLabel(SalaryPayField.ALLOWANCE_AMOUNT.getInfo()).fieldType(FieldType.AMOUNT.getCode()).build());
