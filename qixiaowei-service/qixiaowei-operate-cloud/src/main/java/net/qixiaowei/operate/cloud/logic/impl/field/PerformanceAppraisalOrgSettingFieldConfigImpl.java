...
public class PerformanceAppraisalOrgSettingFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(PerformanceAppraisalOrgSettingField.EVALUATION_TYPE.getCode(), FieldConfig.builder().businessType(BusinessType.PERFORMANCE_APPRAISAL_ORG_SETTING.getCode()).fieldName(PerformanceAppraisalOrgSettingField.EVALUATION_TYPE.getCode()).fieldLabel(PerformanceAppraisalOrgSettingField.EVALUATION_TYPE.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
