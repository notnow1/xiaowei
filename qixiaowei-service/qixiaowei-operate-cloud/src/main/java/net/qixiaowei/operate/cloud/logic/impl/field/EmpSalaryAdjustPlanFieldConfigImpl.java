...
public class EmpSalaryAdjustPlanFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(EmpSalaryAdjustPlanField.ADJUST_DEPARTMENT_ID.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.DEPARTMENT_ID.getCode()).fieldLabel(EmpSalaryAdjustPlanField.DEPARTMENT_ID.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
//        INIT_MAP.put(EmpSalaryAdjustPlanField.DEPARTMENT_LEADER_ID.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.DEPARTMENT_LEADER_ID.getCode()).fieldLabel(EmpSalaryAdjustPlanField.DEPARTMENT_LEADER_ID.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        INIT_MAP.put(EmpSalaryAdjustPlanField.POST_ID.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.ADJUST_POST_ID.getCode()).fieldLabel(EmpSalaryAdjustPlanField.ADJUST_POST_ID.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        ...
        INIT_MAP.put(EmpSalaryAdjustPlanField.OFFICIAL_RANK.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getCode()).fieldLabel(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        INIT_MAP.put(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getCode()).fieldLabel(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
        INIT_MAP.put(EmpSalaryAdjustPlanField.BASIC_WAGE.getCode(), FieldConfig.builder().businessType(BusinessType.EMP_SALARY_ADJUST_PLAN.getCode()).fieldName(EmpSalaryAdjustPlanField.ADJUST_EMOLUMENT.getCode()).fieldLabel(EmpSalaryAdjustPlanField.ADJUST_EMOLUMENT.getInfo()).fieldType(FieldType.AMOUNT.getCode()).build());
