...
public interface ProductMapper {
     ...
     * @return 产品表集合
     */
    List<ProductDTO> selectProductListByProductIds(@Param("productIds") List<Long> productIds);
     ...
     * @return
     */
    List<ProductDTO> selectProductQuote(@Param("productIds") List<Long> productIds);
