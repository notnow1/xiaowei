...
public class PerformanceAppraisalPersonReviewFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(PerformanceAppraisalPersonReviewField.EVALUATION_TYPE.getCode(), FieldConfig.builder().businessType(BusinessType.PERFORMANCE_APPRAISAL_PERSON_REVIEW.getCode()).fieldName(PerformanceAppraisalPersonReviewField.EVALUATION_TYPE.getCode()).fieldLabel(PerformanceAppraisalPersonReviewField.EVALUATION_TYPE.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
