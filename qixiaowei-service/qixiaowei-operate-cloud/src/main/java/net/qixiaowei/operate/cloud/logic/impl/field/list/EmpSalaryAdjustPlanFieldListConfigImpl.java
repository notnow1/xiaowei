...
public class EmpSalaryAdjustPlanFieldListConfigImpl implements IFieldListConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK_SYSTEM_ID.getCode(), FieldListConfig.builder().fieldWidth(120).sort(8).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        INIT_MAP.put(EmpSalaryAdjustPlanField.ADJUST_OFFICIAL_RANK.getCode(), FieldListConfig.builder().fieldWidth(120).sort(9).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        INIT_MAP.put(EmpSalaryAdjustPlanField.ADJUST_EMOLUMENT.getCode(), FieldListConfig.builder().fieldWidth(130).sort(10).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
