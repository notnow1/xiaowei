...
public interface EmployeeBudgetMapper {
     ...
     * @return 人力预算表
     */
    List<EmployeeBudgetDTO> selectEmployeeBudgetByOfficialRankSystemIds(@Param("departmentIds") List<Long> departmentIds, @Param("officialRankSystemIds") List<Long> officialRankSystemIds, @Param("budgetYear") int budgetYear);
