...
public class ProductUnitController extends BaseController
{
    ...
    */
    ...
    @PostMapping("/add")
    public AjaxResult addSave(@RequestBody ProductUnitDTO productUnitDTO) {
    ...
    */
    ...
    @PostMapping("/edit")
    public AjaxResult editSave(@RequestBody ProductUnitDTO productUnitDTO)
    {
    ...
    */
    ...
    @PostMapping("/remove")
    public AjaxResult remove(@RequestBody ProductUnitDTO productUnitDTO)
    {
    ...
    */
    ...
    @PostMapping("/removes")
    public AjaxResult removes(@RequestBody List<ProductUnitDTO>  ProductUnitDtos)
    {
