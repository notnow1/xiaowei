...
public class PerformanceAppraisalFieldListConfigImpl implements IFieldListConfigStrategy {
    ...
    static {
        INIT_MAP.put(PerformanceAppraisalField.APPRAISAL_NAME.getCode(), FieldListConfig.builder().fieldWidth(140).sort(1).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        INIT_MAP.put(PerformanceAppraisalField.APPRAISAL_YEAR.getCode(), FieldListConfig.builder().fieldWidth(120).sort(2).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        ...
        INIT_MAP.put(PerformanceAppraisalField.CYCLE_FLAG.getCode(), FieldListConfig.builder().fieldWidth(150).sort(4).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
        INIT_MAP.put(PerformanceAppraisalField.CYCLE_TYPE.getCode(), FieldListConfig.builder().fieldWidth(120).sort(5).showFlag(1).fixationFlag(0).showForce(0).fixationForce(0).build());
