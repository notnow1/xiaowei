...
public class PerformanceAppraisalPersonSettingFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(PerformanceAppraisalPersonSettingField.EVALUATION_TYPE.getCode(), FieldConfig.builder().businessType(BusinessType.PERFORMANCE_APPRAISAL_PERSON_SETTING.getCode()).fieldName(PerformanceAppraisalPersonSettingField.EVALUATION_TYPE.getCode()).fieldLabel(PerformanceAppraisalPersonSettingField.EVALUATION_TYPE.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
