...
public class BonusPayApplicationFieldConfigImpl implements IFieldConfigStrategy {
    ...
    static {
        ...
        INIT_MAP.put(BonusPayApplicationField.DEPARTMENT_ID.getCode(), FieldConfig.builder().businessType(BusinessType.BONUS_PAY_APPLICATION.getCode()).fieldName(BonusPayApplicationField.DEPARTMENT_ID.getCode()).fieldLabel(BonusPayApplicationField.DEPARTMENT_ID.getInfo()).fieldType(FieldType.TEXT.getCode()).build());
